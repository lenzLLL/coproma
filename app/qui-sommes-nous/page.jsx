...
export default function QuiSommesNous() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[#121212]">
      ...
      <section className="relative  lg:mt-0 h-[75%]   lg:h-[480px] flex items-center justify-center overflow-hidden bg-gradient-to-br from-[#2E7D32] via-[#43A047] to-[#1B5E20] dark:from-[#1B5E20] dark:via-[#388E3C] dark:to-[#121212]">
