...
export default function PolesActivite() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[#121212]">
      ...
      <section className="relativeh-[85%] h-[85%] lg:h-[480px] flex items-center justify-center overflow-hidden bg-gradient-to-br from-[#2E7D32] via-[#43A047] to-[#1B5E20] dark:from-[#1B5E20] dark:via-[#388E3C] dark:to-[#121212]">
